const SETTINGS = {
    trelloStyle: true,
    animateEnd: true,
    transformOriginMode: 'mouce', // or 'center'
    scale: 1.1,
    rotationOffset: {
        min: 1.2,
        max: 2
    ...
    methods: {
        onDragStart(e, index) {
            ...
            let paddingRight = parseFloat(
                getComputedStyle(cardEl).paddingRight
            );
            ...
            this.ghostCardStyle.percentDistanceMiddle =
                Math.round(this.ghostCardStyle.percentDistanceMiddle * 100) /
                100;
        },
        ...
        updateUI() {
            ...
            if (this.draggedCardIdx === -1 || this.ghostCardStyle.leaving)
                return;
        ...
        onDragStop() {
            ...
            let cardEl =
                this.$refs[`card-${this.draggedCardIdx}`] &&
                this.$refs[`card-${this.draggedCardIdx}`][0];
            let cardRect = cardEl.getBoundingClientRect();
        ...
        setGhostCardStyle(isDragstart) {
            ...
            this.ghostCardStyle.pos.x =
                dragX - this.ghostCardStyle.cursorDistance.x;
            this.ghostCardStyle.pos.y =
                dragY - this.ghostCardStyle.cursorDistance.y;
        },
